...
# Video
cap = cv2.VideoCapture("CarCounter2/Car2.mp4")
cv2.namedWindow("frame" , cv2.WND_PROP_FULLSCREEN)
cv2.setWindowProperty("frame" , cv2.WND_PROP_FULLSCREEN , cv2.WINDOW_FULLSCREEN)
# Mask
LeftMask = cv2.imread("CarCounter2/Left.png")
RightMask =  cv2.imread("CarCounter2/Right.png")
# Model
...
while True:
    ...
    # Line
    LeftLimits = [230 , 600 , 500 , 600]
    RightLimits = [500 , 600 , 1150 , 650]
    ...
    for Leftupdate in Leftupdates:
        ...
        cvzone.putTextRect(frame , f"Left: {len(Leftcounted)}" , (5 , 30) , scale = 2 , thickness = 2)
    ...
    cvzone.putTextRect(frame , f"{len(Rightcounted)} :Right" , (1135 , 30) , scale = 2 , thickness = 2)   
    # show
